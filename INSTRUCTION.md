...
> **Обои:** используется оригинальная обоина пользователя `background_default.jpg` (1920×1280, JPEG) — масштабируется в 1024×768 методом cover-crop без искажений пропорций.
