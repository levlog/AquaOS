...
>
> **v4 (текущая):** нативное разрешение **1920×1080** (16:9 — на фуллскрине ничего не сплющено и текст не мылится), приложение **Терминал** с настоящим busybox sh, клавиатура, анимации macOS, dirty-rect рендеринг.
